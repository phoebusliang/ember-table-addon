...
define('dummy/components/configurable-table', ['exports', 'ember', 'ember-table/components/ember-table'], function (exports, Ember, TableComponent) {
  ...
  exports['default'] = TableComponent['default'].extend({
    ...
    parentWidthObserver: Ember['default'].computed(function () {
  ...
  exports['default'] = TableComponent['default'].extend({
    ...
    actions: {
      ...
      toggleCollapse: function (row) {
        ...
        return Ember['default'].run.next(this, function () {
          return this.notifyPropertyChange("rows");
        });
      }
    } });
...
define('dummy/templates/configurable-columns', ['exports', 'ember'], function (exports, Ember) {
  ...
  function program7(depth0,data) {
    ...
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    stack1 = helpers['if'].call(depth0, "canAutoResize", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(18, program18, data),contexts:[depth0],types:["ID"],data:data});
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  ...
  function program22(depth0,data) {
    ...
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n      </div>\n    </div>\n\n    <div class=\"col-md-12 bumper-30\">\n      <h3>Template</h3>\n      <div class=\"highlight\">\n<pre class=\"lang-html\">&#123;&#123;table-component\n  hasFooter=false\n  columns=columns\n  content=content");
    ...
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n&#125;&#125;</pre>\n      </div>\n    </div>\n\n    <div class=\"col-md-12 bumper-30\">\n      <h3>Controller</h3>\n      <div class=\"highlight\">\n<pre class=\"lang-coffee\">App.ApplicationController = Ember.Controller.extend\n  numRows: 100\n\n  columns: Ember.computed -> ");
...
define('dummy/views/ajax-image-table-cell', ['exports', 'dummy/views/table-cell'], function (exports, TableCell) {
...
define('dummy/views/ajax-table-lazy-data-source', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].ArrayProxy.extend({
    ...
    requestGithubEvent: function (page) {
      ...
      return _.range(start, end).forEach(function (index) {
        return content[index] = Ember['default'].Object.create({
          eventId: index,
          isLoaded: false
        });
      });
...
define('dummy/views/bar-table-cell', ['exports', 'ember', 'dummy/views/table-cell'], function (exports, Ember, TableCell) {
...
define('dummy/views/column-sortable-indicator', ['exports', 'ember', 'ember-table/mixins/style-bindings', 'ember-table/mixins/register-table-component'], function (exports, Ember, StyleBindingsMixin, RegisterTableComponentMixin) {
...
define('dummy/views/configurable-column-definition', ['exports', 'ember', 'ember-table/models/column-definition'], function (exports, Ember, ColumnDefinition) {
  ...
  exports['default'] = ColumnDefinition['default'].extend({
    ...
    headerCellNameLowerCase: Ember['default'].computed(function () {
      return this.get("headerCellName").toLowerCase();
    }).property("headerCellName"),

    isDateCell: Ember['default'].computed.equal("headerCellName", "Date"),

    textAlignIsDefault: Ember['default'].computed.equal("textAlign", "text-align-right"),

    minWidthIsDefault: Ember['default'].computed.equal("minWidth", 25)
  });
...
define('dummy/views/editable-table-cell', ['exports', 'ember', 'dummy/views/table-cell'], function (exports, Ember, TableCell) {
...
define('dummy/views/financial-table-cell', ['exports', 'dummy/views/table-cell'], function (exports, TableCell) {
...
define('dummy/views/financial-table-header-cell', ['exports', 'dummy/views/header-cell'], function (exports, HeaderCell) {
...
define('dummy/views/financial-table-header-tree-cell', ['exports', 'dummy/views/header-cell'], function (exports, HeaderCell) {
...
define('dummy/views/financial-table-tree-cell', ['exports', 'ember', 'dummy/views/table-cell'], function (exports, Ember, TableCell) {
...
define('dummy/views/header-block', ['exports', 'ember', 'dummy/views/table-block'], function (exports, Ember, TableBlock) {
...
define('dummy/views/header-cell', ['exports', 'ember', 'ember-table/mixins/style-bindings', 'ember-table/mixins/register-table-component'], function (exports, Ember, StyleBindingsMixin, RegisterTableComponentMixin) {
  ...
  exports['default'] = Ember['default'].View.extend(StyleBindingsMixin['default'], RegisterTableComponentMixin['default'], {
    ...
    cellWidthDidChange: Ember['default'].observer(function () {
      return Ember['default'].run.schedule("afterRender", this, this.elementSizeDidChange);
    }, "width"),

    resizableObserver: Ember['default'].observer(function () {
...
define('dummy/views/header-row', ['exports', 'ember', 'ember-table/mixins/style-bindings', 'ember-table/mixins/register-table-component'], function (exports, Ember, StyleBindingsMixin, RegisterTableComponentMixin) {
...
define('dummy/views/header-table-container', ['exports', 'ember', 'ember-table/views/table-container', 'ember-table/mixins/show-horizontal-scroll', 'ember-table/mixins/register-table-component'], function (exports, Ember, TableContainer, ShowHorizontalScrollMixin, RegisterTableComponentMixin) {
...
define('dummy/views/horizon-table-cell', ['exports', 'ember', 'dummy/views/table-cell', 'dummy/utils/horizon'], function (exports, Ember, TableCell, d3HorizonUtils) {
...
define('dummy/views/lazy-table-block', ['exports', 'ember', 'ember-table/mixins/register-table-component', 'ember-table/views/lazy-container'], function (exports, Ember, RegisterTableComponentMixin, LazyContainerView) {
...
define('dummy/views/multi-item-collection', ['exports', 'ember', 'ember-table/mixins/style-bindings'], function (exports, Ember, StyleBindingsMixin) {
...
define('dummy/views/rating-table-cell', ['exports', 'ember', 'dummy/views/table-cell'], function (exports, Ember, TableCell) {
  ...
  exports['default'] = TableCell['default'].extend({
    ...
    applyRating: function (rating) {
      ...
      return Ember['default'].$(span).addClass("active");
    },
...
define('dummy/views/scroll-container', ['exports', 'ember', 'ember-table/mixins/style-bindings', 'ember-table/mixins/register-table-component', 'ember-table/mixins/scroll-handler'], function (exports, Ember, StyleBindingsMixin, RegisterTableComponentMixin, ScrollHandlerMixin) {
...
define('dummy/views/scroll-panel', ['exports', 'ember', 'ember-table/mixins/style-bindings', 'ember-table/mixins/register-table-component'], function (exports, Ember, StyleBindingsMixin, RegisterTableComponentMixin) {
...
define('dummy/views/sparkline-table-cell', ['exports', 'ember', 'dummy/views/table-cell'], function (exports, Ember, TableCell) {
...
define('dummy/views/table-block', ['exports', 'ember', 'ember-table/mixins/style-bindings', 'ember-table/mixins/register-table-component'], function (exports, Ember, StyleBindingsMixin, RegisterTableComponentMixin) {
...
define('dummy/views/table-cell', ['exports', 'ember', 'ember-table/mixins/style-bindings'], function (exports, Ember, StyleBindingsMixin) {
...
define('dummy/views/table-row', ['exports', 'ember', 'ember-table/mixins/register-table-component', 'ember-table/views/lazy-item'], function (exports, Ember, RegisterTableComponentMixin, LazyItemView) {
...
if (runningTests) {
  ...
  require("dummy/app")["default"].create({"name":"ember-table","version":"0.0.5.f52eb16f"});
}

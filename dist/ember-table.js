...
window.Ember.TEMPLATES['body-container'] = require('ember-table/views/body-table-container')['default'];
window.Ember.TEMPLATES['footer-container'] = require('ember-table/views/footer-table-container')['default'];
window.Ember.TEMPLATES['header-container'] = require('ember-table/views/header-table-container')['default'];
